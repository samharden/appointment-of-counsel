...
def hillsborough_dui_specific(request):
        ...
        if party_name.is_valid():
            ...
            if 'Farr' in str(judge):
                ...
                return render(request,
                                'crim/fl/hills/dui/farr-dui-specific.html',
                                {
                                'first': first,
                                'last': last,
                                'date': date,
                ...
                return render(request, 'crim/fl/hills/dui/jeske-dui-specific.html',
                                {
                                'first': first,
                                'last': last,
                                })
                ...
                return render(request, 'crim/fl/hills/dui/mcneil-dui-specific.html',
                                {
                                'first': first,
                                'last': last,
                                })
            elif 'Myers' in str(judge):
                return render(request, 'crim/fl/hills/dui/myers-dui-specific.html',
                                {
                                'first': first,
                                'last': last,
                                })
            elif 'Taylor' in str(judge):
                return render(request, 'crim/fl/hills/dui/taylor-dui-specific.html',
                                {
                                'first': first,
                                'last': last,
                                })
    ...
    return render(request, 'crim/fl/hills/hillsborough-dui-case-search.html',
                            {
